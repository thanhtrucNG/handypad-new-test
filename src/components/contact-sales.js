...
const DRAFT_KEY = 'handypad.contact-sales.v1';
...
export function createContactSalesModal(storage = null) {
  ...
  const intro = element('p', 'contact-sales-intro', t('Not sure which HANDYPAD option fits your worksite? Leave your contact details and our team will advise you.'));
